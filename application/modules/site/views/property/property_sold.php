									...
									<div class="col-md-5">
										<div class="property-mask property-image">
                                        	<figure class="pimage">
                                                ...
                                                <h4> <a href="#" rel="tag"><?php echo $price_display;?></a></h4>	
									...
									<div class="col-md-7">
										<div class="agent-property-desc">
											<div class="property-desc">
												<h4><a href="<?php echo base_url();?>properties/view-single/<?php echo $rental_unit_id;?>"><?php echo $rental_unit_name;?>, <?php echo $location_name;?></a></h4><label></label><p><?php echo $mini_desc;?></p>
											...
											<a href="<?php echo base_url();?>properties/view-single/<?php echo $rental_unit_id;?>" class="view-profile">
												 More details		</a>
										</div>
									</div>
								</div>
